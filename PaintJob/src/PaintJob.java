...
public class PaintJob {
    ...
    /**
     * Computes the number of buckets needed for a paint job
     * @param width the width
     * @param height the height
     * @param areaPerBucket the area of one bucket
     * @param extraBuckets the extra buckets
     * @return the number of needed buckets
     */
    ...
    /**
     * Computes the number of buckets needed for a paint job
     * @param area the area of the wall to be painted
     * @param areaPerBucket the area of one bucket
     * @return the number of needed buckets
     */
    ...
    public static void main(String[] args) {
        // testing the first method above
        ...
        System.out.println();
        // testing the second method above
        ...
        System.out.println();
        // testing the third method above
